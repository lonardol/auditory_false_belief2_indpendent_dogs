...
for (j in seq_along(n.subject)) {
  ...
  sim_fun <- function(i) {
    ...
    # Sample breed per subject (factor with only sampled levels)
  ...
  num_cols <- c("icpt","conditiontrue_belief","conditionknowledge_sound_control",
                ...
                "warns.full","warns.null","re.sd","lrt.p.fullnull",
                "lrt.p.drop1.condition_breed_type","lrt.p.drop1.sex","lrt.p.drop1.baited_fst","lrt.p.drop1.z_age",
